#
# HOME documentation build configuration file, created by
...
man_pages = [("index", "TEKSI", "TEKSI Documentation", ["TEKSI"], 1)]
...
texinfo_documents = [
    (
        ...
        "TEKSI Community",
        "TEKSI",
        "TEKSI, the swiss association for open source projects for administration of public infrastructures",
        "Miscellaneous",
    ),
]
